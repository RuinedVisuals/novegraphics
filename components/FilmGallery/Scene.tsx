    ...
    <group ref={groupRef} onClick={handleClick}>
      {isCurrentActive && (
        <mesh ref={stackRef} raycast={() => null}>
          ...
          <meshBasicMaterial ref={stackMatRef} map={frontTexture} transparent opacity={0} toneMapped={false} side={THREE.DoubleSide} />
        </mesh>
      )}
      ...
      <group>
        ...
        <mesh>
          <planeGeometry args={isCurrentActive ? [1.15, 1.68] : [0.34, 1.68]} />
          <meshBasicMaterial
            ref={mainMatRef}
      ...
      {isCurrentActive && (
        <mesh position={[0, 0, -0.035]} rotation={[0, Math.PI, 0]} raycast={() => null}>
          <planeGeometry args={[1.15, 1.68]} />
          <meshBasicMaterial map={backTexture} transparent opacity={0.65} toneMapped={false} side={THREE.DoubleSide} />
        </mesh>
      )}
    </group>
  );
